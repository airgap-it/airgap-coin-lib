...
import { RawXrpTransaction, SerializedUnsignedXrpTransaction } from './unsigned-transactions/xrp-transactions.serializer'
...
export interface UnsignedTransaction {
  transaction: RawEthereumTransaction | RawBitcoinTransaction | RawAeternityTransaction | RawTezosTransaction | RawXrpTransaction
  publicKey: string
  callback?: string
}
...
export type SerializedUnsignedTransaction =
  ...
  | SerializedUnsignedXrpTransaction
