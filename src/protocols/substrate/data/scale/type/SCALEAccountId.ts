...
export class SCALEAccountId extends SCALEType {
    public static from(value: string | Uint8Array | Buffer | SubstrateAddress): SCALEAccountId {
        const address: SubstrateAddress = value instanceof SubstrateAddress ? value : SubstrateAddress.from(bytesToHex(value))
    ...
    private constructor(readonly address: SubstrateAddress) { super() }
