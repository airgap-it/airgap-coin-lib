...
export class SubstrateTransactionController {
    ...
    public async createTransaction(
        ...
        return SubstrateTransaction.create(type, {
            from: accountId,
    ...
    public async createTransactionMethod(
        ...
        return SubstrateTransactionMethod.create(type, methodId.moduleIndex, methodId.callIndex, args)
    }
    ...
    public decodeDetails(serialized: string): SubstrateTransactionDetails[] {
        ...
        return encodedTxs.map(encodedTx => {
            ...
            const transaction = txDecoder.decodeNextObject(hex => SubstrateTransaction.decode(type.decoded.value, hex))
            const payload = txDecoder.decodeNextObject(hex => SubstrateTransactionPayload.decode(type.decoded.value, hex))
