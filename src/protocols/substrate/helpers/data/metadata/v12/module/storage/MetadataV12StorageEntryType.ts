...
export abstract class MetadataV12StorageEntryType extends SCALEClass {
  public static decode(network: SubstrateNetwork, raw: string): SCALEDecodeResult<MetadataV12StorageEntryType> {
    const prefix = parseInt(raw.substr(0, 2), 16)

    let decoderMethod: DecoderMethod<MetadataV12StorageEntryType>
    switch (prefix) {
      case 0:
        decoderMethod = MetadataV12StorageEntryPlain.decode
        break
      case 1:
        decoderMethod = MetadataV12StorageEntryMap.decode
        break
      case 2:
        decoderMethod = MetadataV12StorageEntryDoubleMap.decode
        break
      default:
...
export class MetadataV12StorageEntryPlain extends MetadataV12StorageEntryType {
  public static decode(network: SubstrateNetwork, raw: string): SCALEDecodeResult<MetadataV12StorageEntryPlain> {
    ...
    return {
      ...
      decoded: new MetadataV12StorageEntryPlain(name.decoded)
    }
  }
...
export class MetadataV12StorageEntryMap extends MetadataV12StorageEntryType {
  public static decode(network: SubstrateNetwork, raw: string): SCALEDecodeResult<MetadataV12StorageEntryMap> {
    const decoder = new SCALEDecoder(network, raw)
    ...
    return {
      ...
      decoded: new MetadataV12StorageEntryMap(hasher.decoded, key.decoded, value.decoded, unused.decoded)
    }
  }
...
export class MetadataV12StorageEntryDoubleMap extends MetadataV12StorageEntryType {
  public static decode(network: SubstrateNetwork, raw: string): SCALEDecodeResult<MetadataV12StorageEntryDoubleMap> {
    const decoder = new SCALEDecoder(network, raw)
    ...
    return {
      ...
      decoded: new MetadataV12StorageEntryDoubleMap(hasher1.decoded, key1.decoded, key2.decoded, value.decoded, hasher2.decoded)
    }
  }
