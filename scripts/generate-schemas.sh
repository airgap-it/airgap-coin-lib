...
node_modules/.bin/ts-json-schema-generator --path 'packages/core/src/serializer-v3/schemas/definitions/signed-transaction-rsk.ts' --tsconfig 'tsconfig.json' > packages/core/src/serializer-v3/schemas/generated/transaction-sign-response-rsk.json
...
node_modules/.bin/ts-json-schema-generator --path 'packages/core/src/serializer-v3/schemas/definitions/unsigned-transaction-ethereum-typed.ts' --tsconfig 'tsconfig.json' > packages/core/src/serializer-v3/schemas/generated/transaction-sign-request-ethereum-typed.json
...
node_modules/.bin/ts-json-schema-generator --path 'packages/core/src/serializer-v3/schemas/definitions/unsigned-transaction-rsk-typed.ts' --tsconfig 'tsconfig.json' > packages/core/src/serializer-v3/schemas/generated/transaction-sign-request-rsk-typed.json
node_modules/.bin/ts-json-schema-generator --path 'packages/core/src/serializer-v3/schemas/definitions/unsigned-transaction-rsk.ts' --tsconfig 'tsconfig.json' > packages/core/src/serializer-v3/schemas/generated/transaction-sign-request-rsk.json
