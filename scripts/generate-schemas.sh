...
# Tests
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/AnyMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/any-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/ArrayMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/array-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/BooleanMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/boolean-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/ComplexMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/complex-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/HexMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/hex-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/NumberMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/number-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/ObjectMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/object-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/StringMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/string-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/SimpleMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/simple-message.json
./node_modules/.bin/ts-json-schema-generator --path 'test/serializer/schemas/definitions/TupleMessage.ts' --tsconfig 'tsconfig.json' > test/serializer/schemas/generated/tuple-message.json
