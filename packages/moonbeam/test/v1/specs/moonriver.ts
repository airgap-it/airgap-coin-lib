...
import { MoonriverProtocolImpl } from '../../../src/v1/protocol/MoonriverProtocol'
...
export class MoonriverTestProtocolSpec extends TestProtocolSpec<MoonriverUnits> {
  public name = 'Moonriver'
  public lib = new MoonriverProtocolImpl()
