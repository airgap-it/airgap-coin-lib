...
export class MoonbeamProtocolStub implements ProtocolHTTPStub<MoonbeamUnits> {
  public async registerStub(testProtocolSpec: TestProtocolSpec<MoonbeamUnits>): Promise<void> {
    sinon
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec<MoonbeamUnits>): Promise<void> {
    sinon
      .stub(testProtocolSpec.lib.accountController, 'getBalance')
      .withArgs(sinon.match.any)
      .returns(
  ...
  private async registerDefaultStub(testProtocolSpec: TestProtocolSpec<MoonbeamUnits>): Promise<void> {
    sinon
  ...
  public async transactionListStub(testProtocolSpec: TestProtocolSpec<MoonbeamUnits>, address: string): Promise<any> {
