...
import { MoonriverProtocol } from '../../../src/v0'
import { ProtocolHTTPStub, TestProtocolSpec } from '../implementations'

export class MoonriverProtocolStub implements ProtocolHTTPStub {
  public async registerStub(testProtocolSpec: TestProtocolSpec, protocol: MoonriverProtocol): Promise<void> {
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec, protocol: MoonriverProtocol): Promise<void> {
    const protocolOptions = await protocol.getOptions()
  ...
  private async registerDefaultStub(testProtocolSpec: TestProtocolSpec, protocol: MoonriverProtocol): Promise<void> {
    const protocolOptions = await protocol.getOptions()
