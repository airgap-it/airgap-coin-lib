...
export class PolkadotProtocolStub implements ProtocolHTTPStub<PolkadotUnits> {
  public async registerStub(testProtocolSpec: TestProtocolSpec<PolkadotUnits>): Promise<void> {
    sinon
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec<PolkadotUnits>): Promise<void> {
    sinon
      .stub(testProtocolSpec.lib.accountController, 'getBalance')
      .withArgs(sinon.match.any)
      .returns(
  ...
  private async registerDefaultStub(testProtocolSpec: TestProtocolSpec<PolkadotUnits>): Promise<void> {
    sinon
  ...
  public async transactionListStub(testProtocolSpec: TestProtocolSpec<PolkadotUnits>, address: string): Promise<any> {
