...
export class KusamaProtocolStub implements ProtocolHTTPStub<KusamaUnits> {
  public async registerStub(testProtocolSpec: TestProtocolSpec<KusamaUnits>): Promise<void> {
    sinon
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec<KusamaUnits>): Promise<void> {
    sinon
      .stub(testProtocolSpec.lib.accountController, 'getBalance')
      .withArgs(sinon.match.any)
      .returns(
  ...
  private async registerDefaultStub(testProtocolSpec: TestProtocolSpec<KusamaUnits>): Promise<void> {
    sinon
    ...
    sinon.stub(testProtocolSpec.lib.nodeClient, 'getRuntimeVersion').returns(Promise.resolve({ specVersion: 2030, transactionVersion: 1 }))
  }

  public async transactionListStub(testProtocolSpec: TestProtocolSpec<KusamaUnits>, address: string): Promise<any> {
