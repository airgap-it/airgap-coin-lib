...
export class ShidenProtocolStub implements ProtocolHTTPStub<ShidenUnits> {
  public async registerStub(testProtocolSpec: TestProtocolSpec<ShidenUnits>): Promise<void> {
    sinon
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec<ShidenUnits>): Promise<void> {
    sinon
      .stub(testProtocolSpec.lib.accountController, 'getBalance')
      .withArgs(sinon.match.any)
      .returns(
  ...
  private async registerDefaultStub(testProtocolSpec: TestProtocolSpec<ShidenUnits>): Promise<void> {
    sinon
  ...
  public async transactionListStub(testProtocolSpec: TestProtocolSpec<ShidenUnits>, address: string): Promise<any> {
