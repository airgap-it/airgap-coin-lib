...
import { AstarUnits } from '../../../src/v1'
import { ProtocolHTTPStub, TestProtocolSpec } from '../implementations'

export class AstarProtocolStub implements ProtocolHTTPStub<AstarUnits> {
  public async registerStub(testProtocolSpec: TestProtocolSpec<AstarUnits>): Promise<void> {
    sinon
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec<AstarUnits>): Promise<void> {
    sinon
      .stub(testProtocolSpec.lib.accountController, 'getBalance')
      .withArgs(sinon.match.any)
      .returns(
  ...
  private async registerDefaultStub(testProtocolSpec: TestProtocolSpec<AstarUnits>): Promise<void> {
    sinon
  ...
  public async transactionListStub(testProtocolSpec: TestProtocolSpec<AstarUnits>, address: string): Promise<any> {
