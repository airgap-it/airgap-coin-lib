...
import { AstarProtocolImpl } from '../../../src/v1/protocol/AstarProtocol'
...
export class AstarTestProtocolSpec extends TestProtocolSpec<AstarUnits> {
  public name = 'Astar'
  public lib = new AstarProtocolImpl()
