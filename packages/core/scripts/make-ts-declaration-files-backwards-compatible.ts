...
replaceInFile(
  `${dist}/protocols/substrate/helpers/data/metadata/v11/module/storage/MetadataV11StorageEntryType.d.ts`, 
  'protected get scaleFields(): SCALEType[];', 
  'protected readonly scaleFields: SCALEType[];'
)
replaceInFile(
  `${dist}/protocols/substrate/helpers/data/transaction/SubstrateSignature.d.ts`, 
