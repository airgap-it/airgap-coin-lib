...
export class MoonbaseProtocolStub implements ProtocolHTTPStub {
  ...
  public noBalanceStub(testProtocolSpec: TestProtocolSpec, protocol: MoonbeamProtocol): void {
    sinon
      .stub(protocol.options.accountController, 'getTransferableBalance')
      .withArgs(sinon.match.any)
  ...
  private registerDefaultStub(testProtocolSpec: TestProtocolSpec, protocol: MoonbeamProtocol): void {
    sinon
