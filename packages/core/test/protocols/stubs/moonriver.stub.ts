...
export class MoonriverProtocolStub implements ProtocolHTTPStub {
  public registerStub(testProtocolSpec: TestProtocolSpec, protocol: MoonriverProtocol): void {
    sinon
  ...
  public noBalanceStub(testProtocolSpec: TestProtocolSpec, protocol: MoonriverProtocol): void {
    sinon
      .stub(protocol.options.accountController, 'getTransferableBalance')
      .withArgs(sinon.match.any)
  ...
  private registerDefaultStub(testProtocolSpec: TestProtocolSpec, protocol: MoonriverProtocol): void {
    sinon
