...
export class AstarProtocolStub implements ProtocolHTTPStub {
  public registerStub(testProtocolSpec: TestProtocolSpec, protocol: AstarProtocol): void {
    sinon
  ...
  public noBalanceStub(testProtocolSpec: TestProtocolSpec, protocol: AstarProtocol): void {
    sinon
      .stub(protocol.options.accountController, 'getTransferableBalance')
      .withArgs(sinon.match.any)
  ...
  private registerDefaultStub(testProtocolSpec: TestProtocolSpec, protocol: AstarProtocol): void {
