...
export class MetadataV13 extends MetadataVersioned {
  public static decode(network: SubstrateNetwork, runtimeVersion: number | undefined, raw: string): MetadataV13 {
  ...
  private createDecoratedStorageEntries(storage: MetadataV13Storage | undefined): SubstrateStorageEntry[] | undefined {
    if (storage) {
