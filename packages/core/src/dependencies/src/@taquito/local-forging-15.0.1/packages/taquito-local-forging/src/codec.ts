...
} from '../../../../../@taquito/utils-15.0.1/packages/taquito-utils/src/taquito-utils';
...
export const prefixEncoder = (prefix: Prefix) => (str: string) => {
  return buf2hex(Buffer.from(b58cdecode(str, prefixMap[prefix])) as any);
};
...
export const entrypointDecoder = (value: Uint8ArrayConsumer): any => {
...
export const burnLimitDecoder = (value: Uint8ArrayConsumer): any => {
