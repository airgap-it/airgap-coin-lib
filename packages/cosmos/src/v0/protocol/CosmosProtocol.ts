...
export class CosmosProtocol extends NonExtendedProtocol implements ICoinDelegateProtocol {
  ...
  public async getOptions(): Promise<CosmosProtocolOptions> {
    return this.options
  }
  ...
  public async getAddressFromPublicKey(publicKey: string, cursor?: CosmosAddressCursor): Promise<CosmosAddressResult> {
    const address: CosmosAddress = CosmosAddress.from(publicKey)
  ...
  public async getAddressesFromPublicKey(publicKey: string, cursor?: CosmosAddressCursor): Promise<CosmosAddressResult[]> {
  ...
  public async getTransactionsFromPublicKey(
    ...
    const address: CosmosAddressResult = await this.getAddressFromPublicKey(publicKey)
  ...
  public async signWithPrivateKey(privateKey: string, transaction: CosmosTransaction): Promise<string> {
