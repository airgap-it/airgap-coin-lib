...
export class CoreumV3SerializerCompanion implements AirGapV3SerializerCompanion {
  public readonly schemas: V3SchemaConfiguration[] = [
    {
      type: IACMessageType.TransactionSignRequest,
      schema: { schema: cosmosTransactionSignRequest },
      protocolIdentifier: MainProtocolSymbols.COREUM
    },
    {
  ...
  public async toTransactionSignRequest(
    ...
    switch (identifier) {
      ...
      default:
        throw new UnsupportedError(Domain.COREUM, `Protocol ${identifier} not supported`)
    }
  }
