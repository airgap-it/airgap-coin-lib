...
import { MinaExplorerBlockExplorer } from '../src/v1/block-explorer/MinaExplorerBlockExplorer'
import { MINA_MAINNET_PROTOCOL_NETWORK } from '../src/v1/protocol/MinaProtocol'

// use chai-as-promised plugin
chai.use(chaiAsPromised)
const expect = chai.expect

const blockExplorers: AirGapBlockExplorer[] = [new MinaExplorerBlockExplorer(MINA_MAINNET_PROTOCOL_NETWORK.blockExplorerUrl)]
