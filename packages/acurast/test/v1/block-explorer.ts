...
import { ACURAST_MAINNET_PROTOCOL_NETWORK } from '../../src/v1/protocol/AcurastProtocol'

// use chai-as-promised plugin
chai.use(chaiAsPromised)
const expect = chai.expect

const blockExplorers: AirGapBlockExplorer[] = [new SubscanBlockExplorer(ACURAST_MAINNET_PROTOCOL_NETWORK.blockExplorerUrl)]
