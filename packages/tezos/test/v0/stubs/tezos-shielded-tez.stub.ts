...
import { TezosShieldedTezProtocol } from '../../../src/v0'
import { TezosContractCode } from '../../../src/v0/protocol/types/TezosContractCode'
...
export class TezosShieldedTezProtocolStub implements ProtocolHTTPStub {
  public async registerStub(testProtocolSpec: TezosShieldedTezTestProtocolSpec, protocol: TezosShieldedTezProtocol) {
    ...
    getStub
      .withArgs(
        `${protocolOptions.network.rpcUrl}/chains/main/blocks/head/context/contracts/${testProtocolSpec.tezos.wallet.addresses[0]}/counter`
      )
    ...
    getStub
      .withArgs(
        `${protocolOptions.network.rpcUrl}/chains/main/blocks/head/context/contracts/${testProtocolSpec.tezos.wallet.addresses[0]}/balance`
      )
      .returns(Promise.resolve({ data: 100000000 }))
    getStub
      .withArgs(
        `${protocolOptions.network.rpcUrl}/chains/main/blocks/head/context/contracts/${testProtocolSpec.tezos.wallet.addresses[0]}/manager_key`
      )
  ...
  public async noBalanceStub(testProtocolSpec: TezosShieldedTezTestProtocolSpec, protocol: TezosShieldedTezProtocol) {
    const protocolOptions = await protocol.getOptions()
