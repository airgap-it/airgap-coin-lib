...
import { TezosFA1p2Protocol } from '../../../src/v1'
import { ProtocolHTTPStub, TestProtocolSpec } from '../implementations'

export class TezosFA1p2ProtocolStub implements ProtocolHTTPStub<TezosFA1p2Protocol> {
  public async registerStub(testProtocolSpec: TestProtocolSpec<TezosFA1p2Protocol>) {
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec<TezosFA1p2Protocol>) {
    const protocolNetwork = await testProtocolSpec.lib.getNetwork()
  ...
  public async transactionListStub(testProtocolSpec: TestProtocolSpec<TezosFA1p2Protocol>, address: string): Promise<any> {
    const protocolNetwork = await testProtocolSpec.lib.getNetwork()
