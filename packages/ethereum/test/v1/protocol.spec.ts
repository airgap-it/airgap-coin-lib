    ...
    describe(`Protocol ${protocol.name}`, () => {
      describe(`Public/Private KeyPair`, () => {
        ...
        itIf(
          ...
          'getExtendedKeyPairFromMnemonic - should be able to create an extended key pair from a secret (mnemonic)',
          async () => {
      ...
      describe(`Sign Message`, async () => {
        ...
        itIf(
          ...
          async () => {
            ...
            const { publicKey } = await protocol.lib.getExtendedKeyPairFromSecret(
              { type: 'mnemonic', value: protocol.mnemonic() },
              protocolMetadata.account?.standardDerivationPath
            )
