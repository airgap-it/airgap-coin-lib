...
export abstract class MetadataV13StorageEntryType extends SCALEClass {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    let decoderMethod: DecoderMethod<MetadataV13StorageEntryType, C>
    switch (prefix) {
...
export class MetadataV13StorageEntryPlain extends MetadataV13StorageEntryType {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    const v11 = MetadataV11StorageEntryPlain.decode(configuration, runtimeVersion, raw)
...
export class MetadataV13StorageEntryMap extends MetadataV13StorageEntryType {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    const v11 = MetadataV11StorageEntryMap.decode(configuration, runtimeVersion, raw)
...
export class MetadataV13StorageEntryDoubleMap extends MetadataV13StorageEntryType {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    const v11 = MetadataV11StorageEntryDoubleMap.decode(configuration, runtimeVersion, raw)
...
export class MetadataV13StorageEntryNMap extends MetadataV13StorageEntryType {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    const keyVec = decoder.decodeNextArray((_configuration, _runtimeVersion, hex) => SCALEString.decode(hex))
    const hashers = decoder.decodeNextArray((_configuration, _runtimeVersion, hex) =>
      SCALEEnum.decode(
        hex,
