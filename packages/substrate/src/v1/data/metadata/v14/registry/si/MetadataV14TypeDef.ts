...
export abstract class MetadataV14SiTypeDef extends SCALEClass {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    let decoderMethod: DecoderMethod<MetadataV14SiTypeDef, C>
    switch (prefix) {
...
export class MetadataV14SiTupleTypeDef extends MetadataV14SiTypeDef {
  public static decode<C extends SubstrateProtocolConfiguration>(
    ...
    const value = decoder.decodeNextArray((_configuration, _runtimeVersion, hex) => SCALECompactInt.decode(hex))
