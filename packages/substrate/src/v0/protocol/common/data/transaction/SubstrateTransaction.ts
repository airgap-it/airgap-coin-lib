...
export enum SubstrateTransactionType {
  ...
  M_SCHEDULE_LEAVE_DELEGATORS,
  M_EXECUTE_LEAVE_DELEGATORS,
  M_CANCEL_LEAVE_DELEGATORS,

  M_SCHEDULE_REVOKE_DELGATION,
  M_EXECUTE_DELGATION_REQUEST,
  M_CANCEL_DELEGATION_REQUEST,

  M_DELEGATOR_BOND_MORE,

  M_SCHEDULE_DELEGATOR_BOND_LESS,
  M_EXECUTE_CANDIDATE_BOND_LESS,
  M_CANCEL_CANDIDATE_BOND_LESS
}
