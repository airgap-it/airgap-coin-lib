...
import { StellarBlockExplorer } from '../../src/v1'
import { STELLAR_MAINNET_PROTOCOL_NETWORK } from '../../src/v1/protocol/StellarProtocol'

// use chai-as-promised plugin
chai.use(chaiAsPromised)
const expect = chai.expect

const blockExplorers: AirGapBlockExplorer[] = [new StellarBlockExplorer(STELLAR_MAINNET_PROTOCOL_NETWORK.blockExplorerUrl)]
