...
tezosProtocol.prepareOperations(pubKey, [{ kind: TezosOperationType.TRANSACTION, destination: 'tz1MJx9vhaNRSimcuXPK2rW4fLccQnDAnVKJ', amount: '1' } as any]).then(async wrappedOperations => {
