...
import { SubstrateProtocol } from "../../../src/protocols/substrate/SubstrateProtocol";
import BigNumber from "../../../src/dependencies/src/bignumber.js-9.0.0/bignumber";
import { SubstrateTransactionType } from '../../../src/protocols/substrate/data/transaction/SubstrateTransaction'

export class SubstrateProtocolStub implements ProtocolHTTPStub {

    public registerStub(testProtocolSpec: TestProtocolSpec, protocol: SubstrateProtocol): void {
        sinon
    ...
    public noBalanceStub(testProtocolSpec: TestProtocolSpec, protocol: SubstrateProtocol): void {
        sinon
            .stub(protocol.accountController, 'getTransferableBalance')
            .withArgs(sinon.match.any)
    ...
    private registerDefaultStub(testProtocolSpec: TestProtocolSpec, protocol: SubstrateProtocol): void {
        sinon
