...
import { SubstrateProtocolStub } from "../stubs/substrate.stub";
...
export class SubstrateTestProtocolSpec extends TestProtocolSpec {
    public name = 'Substrate'
    public lib = new SubstrateProtocol()
    public stub = new SubstrateProtocolStub()
